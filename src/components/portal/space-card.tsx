      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        <div className="mt-3 flex flex-wrap gap-x-4 gap-y-1 text-xs font-medium text-navy-500">
          <span className="inline-flex items-center gap-1">
            <Clock className="h-3.5 w-3.5" /> {space.driveMinutes} min to terminal
          </span>
          <span className="inline-flex items-center gap-1">
            <Car className="h-3.5 w-3.5" /> Fits {space.maxVehicleSize}
          </span>
          {space.cctv && (
            <span className="inline-flex items-center gap-1">
              <ShieldCheck className="h-3.5 w-3.5" /> CCTV
            </span>
          )}
        </div>
        ...
        <div className="mt-auto flex items-end justify-between pt-4">
          <div>
            <div className="text-xs text-navy-400">
              {formatMoneyShort(space.pricePerDay, currency)} / day · est. bundle
            </div>
