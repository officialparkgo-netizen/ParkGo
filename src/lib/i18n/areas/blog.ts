...
export const blog: AreaDict = {
  en: {
    ...
    "blog.noResults": "No articles match. Clear the search or pick another topic.",
    "blog.pagePrev": "Newer",
    "blog.pageNext": "Older",
    "blog.rss": "RSS feed",
    ...
    "blog.share": "Share",
    "blog.shareCopy": "Copy link",
    "blog.shareCopied": "Copied",
    "blog.helpfulAsk": "Was this helpful?",
    "blog.helpfulBtn": "Yes, helpful",
    "blog.helpfulThanks": "Thanks for the nod!",
    "blog.alsoIn": "Also available in",
    "blog.previewBanner": "Draft preview — this post is not published yet.",
    "blog.authorTeam":
      "Writing for ParkGo — verified parking, licensed transfers, EV charging and CCTV in one booking.",

    // ---- Newsletter ----
    "blog.sub.title": "New articles, straight to your inbox",
    "blog.sub.sub": "Occasional, practical posts on parking and travel. Unsubscribe in one click.",
    "blog.sub.placeholder": "you@example.com",
    "blog.sub.button": "Subscribe",
    "blog.sub.ok": "You're in — we'll email you when something new is published.",
    "blog.sub.error": "That address didn't work. Check it and try again.",
  ...
  ur: {
    ...
    "blog.filterAll": "تمام موضوعات",
    "blog.noResults": "کوئی مضمون نہیں ملا۔ تلاش صاف کریں یا دوسرا موضوع چنیں۔",
    "blog.pagePrev": "نئے",
    "blog.pageNext": "پرانے",
    "blog.rss": "RSS فیڈ",
    "blog.toc": "اس صفحے پر",
    "blog.related": "آگے پڑھیں",
    "blog.share": "شیئر کریں",
    "blog.shareCopy": "لنک کاپی کریں",
    "blog.shareCopied": "کاپی ہو گیا",
    "blog.helpfulAsk": "کیا یہ مددگار تھا؟",
    "blog.helpfulBtn": "ہاں، مددگار",
    "blog.helpfulThanks": "شکریہ!",
    "blog.alsoIn": "ان زبانوں میں بھی",
    "blog.previewBanner": "ڈرافٹ پیش منظر — یہ مضمون ابھی شائع نہیں ہوا۔",
    "blog.authorTeam":
      "ParkGo کے لیے لکھتے ہیں — تصدیق شدہ پارکنگ، لائسنس یافتہ ٹرانسفر، EV چارجنگ اور CCTV ایک ہی بکنگ میں۔",
    "blog.sub.title": "نئے مضامین سیدھے آپ کے اِن باکس میں",
    "blog.sub.sub": "پارکنگ اور سفر پر کبھی کبھار، کارآمد تحریریں۔ ایک کلک میں اَن سبسکرائب۔",
    "blog.sub.placeholder": "you@example.com",
    "blog.sub.button": "سبسکرائب کریں",
    "blog.sub.ok": "ہو گیا — کچھ نیا شائع ہوتے ہی ای میل ملے گی۔",
    "blog.sub.error": "یہ پتہ درست نہیں۔ چیک کر کے دوبارہ کوشش کریں۔",
  ...
  hi: {
    ...
    "blog.filterAll": "सभी विषय",
    "blog.noResults": "कोई लेख नहीं मिला। खोज साफ़ करें या दूसरा विषय चुनें।",
    "blog.pagePrev": "नए",
    "blog.pageNext": "पुराने",
    "blog.rss": "RSS फ़ीड",
    "blog.toc": "इस पृष्ठ पर",
    "blog.related": "आगे पढ़ें",
    "blog.share": "साझा करें",
    "blog.shareCopy": "लिंक कॉपी करें",
    "blog.shareCopied": "कॉपी हो गया",
    "blog.helpfulAsk": "क्या यह मददगार था?",
    "blog.helpfulBtn": "हाँ, मददगार",
    "blog.helpfulThanks": "धन्यवाद!",
    "blog.alsoIn": "इन भाषाओं में भी",
    "blog.previewBanner": "ड्राफ्ट पूर्वावलोकन — यह लेख अभी प्रकाशित नहीं हुआ।",
    "blog.authorTeam":
      "ParkGo के लिए लिखते हैं — सत्यापित पार्किंग, लाइसेंस प्राप्त ट्रांसफ़र, EV चार्जिंग और CCTV एक ही बुकिंग में।",
    "blog.sub.title": "नए लेख सीधे आपके इनबॉक्स में",
    "blog.sub.sub": "पार्किंग और यात्रा पर कभी-कभार, काम की पोस्ट। एक क्लिक में अनसब्सक्राइब।",
    "blog.sub.placeholder": "you@example.com",
    "blog.sub.button": "सब्सक्राइब करें",
    "blog.sub.ok": "हो गया — कुछ नया प्रकाशित होते ही ईमेल मिलेगा।",
    "blog.sub.error": "यह पता सही नहीं। जाँच कर दोबारा कोशिश करें।",
  ...
  de: {
    ...
    "blog.noResults": "Keine Artikel gefunden. Suche löschen oder ein anderes Thema wählen.",
    "blog.pagePrev": "Neuere",
    "blog.pageNext": "Ältere",
    "blog.rss": "RSS-Feed",
    "blog.toc": "Auf dieser Seite",
    "blog.related": "Weiterlesen",
    "blog.share": "Teilen",
    "blog.shareCopy": "Link kopieren",
    "blog.shareCopied": "Kopiert",
    "blog.helpfulAsk": "War das hilfreich?",
    "blog.helpfulBtn": "Ja, hilfreich",
    "blog.helpfulThanks": "Danke!",
    "blog.alsoIn": "Auch verfügbar auf",
    "blog.previewBanner": "Entwurfsvorschau — dieser Beitrag ist noch nicht veröffentlicht.",
    "blog.authorTeam":
      "Schreibt für ParkGo — verifiziertes Parken, lizenzierte Transfers, EV-Laden und CCTV in einer Buchung.",
    "blog.sub.title": "Neue Artikel direkt in Ihr Postfach",
    "blog.sub.sub": "Gelegentliche, praktische Beiträge zu Parken und Reisen. Abmeldung mit einem Klick.",
    "blog.sub.placeholder": "sie@example.com",
    "blog.sub.button": "Abonnieren",
    "blog.sub.ok": "Fertig — wir mailen Ihnen, sobald etwas Neues erscheint.",
    "blog.sub.error": "Diese Adresse hat nicht funktioniert. Bitte prüfen und erneut versuchen.",
  ...
  zh: {
    ...
    "blog.filterAll": "全部主题",
    "blog.noResults": "没有匹配的文章。清除搜索或选择其他主题。",
    "blog.pagePrev": "较新",
    "blog.pageNext": "较早",
    "blog.rss": "RSS 订阅",
    "blog.toc": "本页目录",
    ...
    "blog.share": "分享",
    "blog.shareCopy": "复制链接",
    "blog.shareCopied": "已复制",
    "blog.helpfulAsk": "这篇文章有帮助吗？",
    "blog.helpfulBtn": "有帮助",
    "blog.helpfulThanks": "谢谢！",
    "blog.alsoIn": "其他语言版本",
    "blog.previewBanner": "草稿预览 — 这篇文章尚未发布。",
    "blog.authorTeam": "为 ParkGo 撰稿 — 认证停车、持牌接送、EV 充电与 CCTV，一次预订全包。",
    "blog.sub.title": "新文章直达您的邮箱",
    "blog.sub.sub": "关于停车与出行的实用文章，偶尔发送。一键退订。",
    "blog.sub.placeholder": "you@example.com",
    "blog.sub.button": "订阅",
    "blog.sub.ok": "订阅成功 — 有新文章发布时我们会邮件通知您。",
    "blog.sub.error": "该地址无效。请检查后重试。",
  ...
  ar: {
    // ---- Index hero ----
    "blog.hero.eyebrow": "مدونة ParkGo",
    "blog.hero.title": "مواقف مطار أذكى وسفر أسهل",
    "blog.hero.subtitle":
      "أدلة عملية حول مواقف السيارات والتوصيلات المرخّصة وشحن المركبات الكهربائية (EV)، والثقة والأمان اللذين يجمعان كل ذلك معًا.",
    ...
    "blog.min": "د",
    "blog.by": "بقلم",
    "blog.backToBlog": "جميع المقالات",
    "blog.tags": "الوسوم",
    "blog.searchPlaceholder": "ابحث في المقالات…",
    "blog.filterAll": "جميع المواضيع",
    "blog.noResults": "لا توجد مقالات مطابقة. امسح البحث أو اختر موضوعًا آخر.",
    "blog.pagePrev": "الأحدث",
    "blog.pageNext": "الأقدم",
    "blog.rss": "خلاصة RSS",
    "blog.toc": "في هذه الصفحة",
    "blog.related": "اقرأ أيضًا",
    "blog.share": "مشاركة",
    "blog.shareCopy": "نسخ الرابط",
    "blog.shareCopied": "تم النسخ",
    "blog.helpfulAsk": "هل كان هذا مفيدًا؟",
    "blog.helpfulBtn": "نعم، مفيد",
    "blog.helpfulThanks": "شكرًا لك!",
    "blog.alsoIn": "متوفر أيضًا باللغات",
    "blog.previewBanner": "معاينة مسودة — هذا المقال لم يُنشر بعد.",
    "blog.authorTeam":
      "نكتب لصالح ParkGo — مواقف موثّقة وتوصيلات مرخّصة وشحن EV وكاميرات CCTV في حجز واحد.",
    "blog.sub.title": "مقالات جديدة مباشرة إلى بريدك الوارد",
    "blog.sub.sub": "منشورات عملية بين حين وآخر عن المواقف والسفر. إلغاء الاشتراك بنقرة واحدة.",
    "blog.sub.placeholder": "you@example.com",
    "blog.sub.button": "اشترك",
    "blog.sub.ok": "تم اشتراكك — سنراسلك عبر البريد عند نشر أي جديد.",
    "blog.sub.error": "هذا العنوان لم يُقبل. تحقق منه وحاول مرة أخرى.",

    // ---- Article CTA ----
    "blog.cta.eyebrow": "اركن بذكاء. سافر بسهولة.",
    "blog.cta.title": "حجز واحد للموقف والتوصيل وشحن EV",
    "blog.cta.body": "اطّلع على مواقف موثّقة قرب مطارك بسعر واحد شفاف.",
    "blog.cta.start": "ابدأ الحجز",
    "blog.cta.more": "المزيد من المقالات",

    // ---- Post: real-cost-of-airport-parking ----
    "blog.post.real-cost-of-airport-parking.title":
      "التكلفة الحقيقية لمواقف المطار (وكيف يعالجها الحجز المدمج)",
    "blog.post.real-cost-of-airport-parking.excerpt":
      "نادرًا ما تروي الأسعار المعلنة القصة كاملة. إليك أين تذهب النقود فعلًا في رحلة مطار اعتيادية — ولماذا يتفوق حجز واحد مدمج عادةً على أربعة حجوزات منفصلة.",
    "blog.post.real-cost-of-airport-parking.body": [
      "اسأل معظم المسافرين عن تكلفة مواقف المطار وسيذكرون لك سعرًا يوميًا. إنها نقطة انطلاق معقولة، لكنها ليست في الغالب المبلغ الذي يُخصم من بطاقتك فعليًا. فبين رسوم الحجز، وزيادات تواريخ الذروة، وانتظار الحافلة المكوكية، والوقود المستهلك في الالتفاف عن الطريق، وشحنة عابرة للسيارة الكهربائية (EV) في إحدى محطات الخدمة على الطريق السريع، قد يتباعد السعر المعلن والسعر الحقيقي تباعدًا كبيرًا.",
      "## أين تذهب النقود فعلًا",
      "تنطوي الرحلة الاعتيادية التي تستغرق أسبوعًا عادةً على أربع عمليات شراء منفصلة: مكان تترك فيه السيارة، ووسيلة للوصول إلى مبنى الركاب، والشحن إن كنت تقود سيارة كهربائية، وراحة البال بمعرفة أن مركبتك في أمان. وعند حجز كل منها على حدة، يحمل كل عنصر رسومه الخاصة وقواعد إلغائه الخاصة وطابور خدمة عملائه الخاص. هذا الاحتكاك هو التكلفة الخفية، وهو يتفاقم لحظة تتأخر رحلة أو تتغير الخطط.",
      "تعلن مواقف السيارات خارج المطار عن أسعار يومية منخفضة، ثم تضيف نقلًا بحافلة مكوكية تسير وفق جدولها الخاص. أما الخيارات داخل المطار فتستغني عن الحافلة لكنها تتقاضى علاوة سعرية مقابل هذه الراحة. ولا يخبرك أي منهما مسبقًا كم سيكلف شحن سيارتك، أو ما إذا كان هناك من يراقبها فعلًا في غيابك.",
      "## لماذا السعر الواحد",
      "تأخذ ParkGo الأمور الأربعة التي يوازن بينها المسافرون عادةً — موقفًا موثّقًا، وتوصيلًا مرخّصًا إلى مبنى الركاب، وشحنًا للسيارة الكهربائية، ومراقبة أمنية مباشرة — وتجمعها في سعر واحد شفاف عند خطوة دفع واحدة. فترى الإجمالي الكامل قبل أن تدفع، لا سعرًا أساسيًا يكبر بهدوء كلما أضفت الأشياء التي تحتاجها فعلًا.",
      "الدمج ليس أكثر ترتيبًا فحسب؛ بل هو أرخص في العادة. فعندما يُباع الموقف والتوصيل معًا، لا توجد رسوم حجز ثانية ولا حافز لحشو سعر يومي منخفض بإضافات مفاجئة. ولأن السعر قابل للتفسير، تخبرك اقتراحاتنا لماذا يشكّل اقتران موقف معيّن بتوصيل معيّن أفضل قيمة لتواريخ سفرك، بدلًا من مجرد الترويج للخيار الأغلى.",
      "## ما الذي تتحقق منه قبل الحجز",
      "أيًا كانت الجهة التي تحجز معها، فثمة ثلاثة أسئلة ستوفر عليك المال والتوتر. أولًا، هل الإجمالي الذي تراه هو الإجمالي الذي تدفعه، شاملًا التوصيل وأي شحن للسيارة الكهربائية؟ ثانيًا، ماذا يحدث إذا تغيّر موعد رحلتك — هل الإلغاء مرن؟ ثالثًا، هل يمكنك فعلًا التحقق من أن الموقف آمن، والأفضل أن يكون ذلك عبر كاميرات CCTV أو كاميرا مباشرة يمكنك متابعتها من هاتفك؟",
      "ليس على مواقف المطار أن تكون لعبة تخمين. فعندما يكون السعر صادقًا وكل ما تحتاجه مجموعًا في حجز واحد، تتطابق التكلفة الحقيقية أخيرًا مع تلك الظاهرة على الشاشة — وهذه بالضبط هي التجربة التي انطلقنا لبنائها.",
    ].join("\n\n"),

    // ---- Post: how-parkgo-verifies-hosts-and-drivers ----
    "blog.post.how-parkgo-verifies-hosts-and-drivers.title":
      "كيف تتحقق ParkGo من المضيفين والتوصيلات المرخّصة",
    "blog.post.how-parkgo-verifies-hosts-and-drivers.excerpt":
      "الثقة هي المنتج. إليك بالتحديد كيف نتحقق من المضيفين الذين يعتنون بسيارتك، وكيف يتعامل مشغّل التوصيل المرخّص الذي نتكامل معه مع امتثال السائقين، وكيف نحافظ على أمان المستندات.",
    "blog.post.how-parkgo-verifies-hosts-and-drivers.body": [
      "تسليم سيارتك إلى شخص غريب والوثوق بآخر ليقلّك إلى رحلتك أمران لا ينجحان إلا إذا كانت عمليات التحقق خلف الكواليس حقيقية. في ParkGo، ليس توثيق المضيف شارة نمنحها باستخفاف — بل هو عملية يكملها كل مضيف قبل أن يتمكن من قبول حجز واحد. أما التوصيل إلى مبنى الركاب فيقدّمه مشغّل مستقل مرخّص نتكامل معه عبر واجهة برمجة التطبيقات (API)، ويقع امتثال السائقين على عاتقه.",
      "## التحقق من المضيفين",
      "قبل أن يصبح أي موقف متاحًا للحجز، يكمل المضيف الذي يقف خلفه التحقق من الهوية، ويؤكد حقه في إدراج الموقف، ويقدّم صورًا فوتوغرافية للموقف الفعلي. نتأكد من العنوان ونُخضِع وثائق الهوية لفحوص معترف بها. وفقط بعد اعتماد تلك المراجعة ينتقل الإعلان من قيد الانتظار إلى منشور ويصبح قابلًا للحجز.",
      "كما يحمل كل موقف تفاصيل واضحة وصادقة: كم يبعد فعليًا عن مبنى الركاب، وما أقصى حجم مركبة يتسع له، وهل يوفر كاميرات CCTV أو كاميرا مباشرة. ولا يستطيع المضيفون تحسين هذه الادعاءات خلسة — فما تراه في الإعلان هو ما جرى التحقق منه.",
      "## مشغّل التوصيل المرخّص",
      "لا تدير ParkGo سائقين تابعين لها ولا تطبيقًا خاصًا بالسائقين. فالتوصيل إلى مبنى الركاب ينفذه مشغّل مستقل مرخّص ومؤمَّن نتصل به عبر API. يحمل ذلك المشغّل رخصة تشغيل النقل الخاص بأجرة، وتأمين نقل الركاب التجاري، وشارة كل سائق، وهو المسؤول عن فحص السائقين واحدًا واحدًا وإعادة التحقق منهم دوريًا — بحيث لا يمكن لشهادة منتهية الصلاحية أن تمر من دون انتباه. نعرض حالته المباشرة واتفاقية مستوى الخدمة (SLA) الخاصة به وتقييماته داخل التطبيق، غير أن الامتثال في جانب السائقين يظل مسؤوليته هو.",
      "في يوم السفر، تتشارك أنت والسائق المرخّص والمضيف خريطة مباشرة واحدة، ويُؤكَّد تسليم السيارة برمز يُستعمل لمرة واحدة يدخله الطرفان معًا. يُختم ذلك الرمز بطابع زمني ويُسجَّل، فيبقى هناك دائمًا سجل واضح لمن استلم السيارة ومتى.",
      "## الحفاظ على أمان المستندات الحساسة",
      "التحقق يعني التعامل مع مواد حساسة — جوازات سفر ورخص قيادة وشهادات تأمين. نتعامل مع مستندات «اعرف عميلك» (KYC) هذه بوصفها فئة منفصلة خاضعة لضوابط وصول، تُحفظ بمعزل عن بيانات الحساب اليومية وتُشفَّر. وتخزّن المنصة مرجعًا يشير إلى المستند لا المستند نفسه، فلا يحتاج من يبنون الميزات إلى لمس الملفات الأصلية أبدًا.",
      "والنتيجة درجة ثقة يمكنك فعلًا فهم منطقها: تُبنى من حالة التوثيق، وتقييمات حقيقية من حجوزات مكتملة، ومن الموثوقية وطول مدة العضوية. إنها ليست مقياسًا للتباهي — بل هي الإشارة نفسها التي نستخدمها داخليًا لنقرر من يستحق مكانًا على المنصة.",
    ].join("\n\n"),

    // ---- Post: ev-charging-while-you-fly ----
    "blog.post.ev-charging-while-you-fly.title": "شحن سيارتك الكهربائية (EV) أثناء سفرك: ما تحتاج إلى معرفته",
    "blog.post.ev-charging-while-you-fly.excerpt":
      "العودة إلى سيارة مشحونة بالكامل واحدة من المتع الهادئة لقيادة السيارات الكهربائية. إليك كيف تستفيد إلى أقصى حد من شحن EV في المطار، من الموصلات إلى التكاليف.",
    "blog.post.ev-charging-while-you-fly.body": [
      "قلّما توجد طريقة أجمل لإنهاء رحلة من العودة سيرًا إلى سيارة شحنت نفسها بهدوء في غيابك. بالنسبة إلى سائقي السيارات الكهربائية (EV)، تمثل مواقف المطار فترة نادرة تظل فيها السيارة ساكنة لأيام — وهي مثالية لشحن بطيء لطيف أرفق بالبطارية من الشحن السريع أثناء التنقل.",
      "## طابق الموصل مع سيارتك",
      "تستخدم معظم عمليات الشحن المنزلية الطابع موصل Type 2 بقدرة تقارب 7 كيلوواط، وهو خيار مثالي لإقامة تمتد عدة أيام: وقت وافر لبلوغ الشحن الكامل دون إجهاد البطارية. أما الخيارات الأسرع التي تعتمد على CCS فيمكنها توفير 22 كيلوواط أو أكثر، وهي مفيدة لرحلة قصيرة تريد أن تغادر بعدها بمدى فائض. قبل الحجز، تأكد من أن الموقف يذكر الموصل والسرعة اللذين تدعمهما سيارتك.",
      "## افهم ما ستدفعه",
      "يُسعَّر شحن السيارات الكهربائية عادةً بالكيلوواط ساعة، لذا تعتمد التكلفة على كمية الطاقة التي تسحبها فعلًا لا على مدة بقائك موصولًا بالشاحن. والموقف الذي يعرض سعره لكل كيلوواط ساعة مسبقًا يتيح لك تقدير التكلفة سلفًا — وعندما يكون الشحن جزءًا من حجز مدمج واحد، يندرج ذلك الرقم ضمن الإجمالي الشفاف نفسه مع موقفك وتوصيلك، من دون تطبيق منفصل أو دفعة منفصلة تتصارع معهما يوم السفر.",
      "## بضع نصائح عملية",
      "احرص على الوصول بمستوى شحن معقول لا ببطارية شبه فارغة؛ فالشحن البطيء من مستوى منخفض على مدى عدة أيام لا بأس به، لكن لا داعي لأن يقترب شحنك من النفاد في طريقك إلى المطار. وإذا كانت سيارتك تتيح ضبط حد أقصى للشحن، فإن 80 بالمئة أرفق بالبطارية في الإقامات الأطول. واحرص على إحضار الكابل أو التأكد من توافره إذا ذكر الإعلان أنه مطلوب — فبعض المضيفين يوفرونه، وآخرون يتوقعون أن تستخدم كابلك الخاص.",
      "الشحن أثناء سفرك واحد من تلك التفاصيل الصغيرة التي تحوّل يوم سفر مرهقًا إلى يوم سهل. اختر موقفًا مزودًا بالموصل المناسب، وتحقق من سعر الكيلوواط ساعة، ودع السيارة تتولى الجزء الممل بينما أنت في مكان أكثر تشويقًا بكثير.",
    ].join("\n\n"),

    // ---- Post: travellers-guide-to-heathrow-parking ----
    "blog.post.travellers-guide-to-heathrow-parking.title":
      "دليل المسافر إلى مواقف مطار هيثرو",
    "blog.post.travellers-guide-to-heathrow-parking.excerpt":
      "هيثرو هو أكثر مطارات المملكة المتحدة ازدحامًا، وقد تبدو مواقفه أشبه بمتاهة. إليك كيف تختار بين مباني الركاب، وتوفر المال، وتصل وأنت مسترخٍ.",
    "blog.post.travellers-guide-to-heathrow-parking.body": [
      "يستقبل هيثرو مسافرين أكثر من أي مطار آخر في المملكة المتحدة، موزّعين على أربعة مبانٍ للركاب وشبكة مترامية من الطرق. وهذا الاتساع تحديدًا هو ما يجعل الركن هناك يكافئ قليلًا من التخطيط — فالفرق بين بداية سلسة وأخرى مرهقة كثيرًا ما يعود إلى اختيار الموقف المناسب لمبنى ركابك.",
      "## اعرف مبنى ركابك أولًا",
      "مباني الركاب في هيثرو متباعدة فعلًا، ولذلك فإن أنفع خطوة يمكنك القيام بها هي التأكد من المبنى الذي تقلع منه قبل حجز أي شيء. يقع المبنيان T2 وT3 في المنطقة المركزية، ويقع T4 جنوبًا، وT5 غربًا وله مدخله المخصص. والموقف الذي يبعد أربع دقائق عن T5 قد يعني انطلاقًا من T4 لفة طويلة رهينة بحركة المرور، لذا طابق الإعلان مع مبنى ركابك لا مع المطار عمومًا.",
      "## مواقف خارج المطار قرب هيثرو",
      "تنتشر في المناطق الملاصقة للمطار — لونغفورد وهاتون كروس وهارلينغتون وهاونزلو — ممرات سيارات خاصة وساحات مسوّرة ببوابات تقع أقرب بكثير إلى مباني الركاب من مواقف الإقامة الطويلة الكبرى. كثير منها لا يبعد سوى دقائق قيادة معدودة، ما يجعل التوصيل المرخّص سريعًا وقابلًا للتوقع، ويوفر عدد منها كاميرات CCTV أو كاميرا مباشرة لتطمئن على سيارتك من صالة المغادرة.",
      "## التوقيت وحركة المرور",
      "تزدحم الطرق المحيطة بهيثرو منذ الصباح الباكر، وقد تختنق منطقة المباني المركزية في أوقات الذروة. احسب هامشًا من الوقت، واختر حيثما أمكن موقفًا يكون زمن القيادة المعلن له محتسبًا لذلك المسار مسبقًا. وحجز باقة تجمع الموقف والتوصيل يزيل التخمين من المرحلة الأخيرة: فسائقك يعرف الطريق إلى مبنى ركابك، فلا تجد نفسك تتلمس طريقك في شبكة طرق باتجاه واحد غير مألوفة وأنت على موعد مع رحلة.",
      "## وفّر المال من دون التفريط في الجودة",
      "نادرًا ما يكون الخيار الأرخص هو صاحب أدنى سعر يومي متى أُخذت الحافلة المكوكية المنفصلة وجدولها في الحساب. انظر بدلًا من ذلك إلى السعر الشامل للموقف مع توصيلك، وراجع تقييمات المسافرين الذين استخدموا الموقف فعلًا، وتأكد من أنه يتسع لمركبتك. والحجز قبل بضعة أيام، لا سيما في مواسم العطل المدرسية، يتفوق في الغالب الأعم على الحضور مباشرة ودفع سعر البوابة.",
      "## صِل وأنت مسترخٍ",
      "ليس على هيثرو أن يكون مصدر رهبة. اختر موقفًا موثّقًا قرب مبنى ركابك المحدد، وأدرج معه توصيلًا مرخّصًا لتكون الدقائق الأخيرة محسومة، واستخدم الكاميرا المباشرة إن كان موقفك يوفرها. افعل ذلك، وسيغدو أكثر مطارات البلاد ازدحامًا واحدًا من أسهل الأماكن لبدء رحلة.",
    ].join("\n\n"),
  },
};
