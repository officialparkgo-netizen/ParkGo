...
export const marketingA: AreaDict = {
  ...
  ar: {
    // -------------------------------------------------------------- How it works
    "how.hero.badge": "حجز واحد · سعر واحد · تطبيق واحد",
    "how.hero.title": "كيف يعمل ParkGo، من البحث إلى التسليم الموثّق",
    "how.hero.subtitle":
      "يتنقّل معظم المسافرين بين ثلاثة تطبيقات وثلاثة أسعار لتدبير الموقف والتوصيل وشحن EV. يجمعها ParkGo في رحلة واحدة موثوقة يمكنك متابعتها طوال الطريق.",
    "how.hero.cta": "ابدأ الحجز",
    "how.hero.pricing": "اطّلع على الأسعار",

    "how.journey.eyebrow": "رحلة المسافر",
    "how.journey.title": "خمس خطوات من البحث عن موقفك حتى الهبوط عائدًا إلى المنزل",
    "how.journey.body":
      "كل خطوة موثّقة وشفافة ومتتبَّعة. لا مفاجآت عند البوابة، ولا تخمين لمكان سيارتك.",

    "how.step1.title": "ابحث وقارن",
    "how.step1.body":
      "أخبرنا بمطارك وتواريخ سفرك. يعرض ParkGo مواقف خاصة موثّقة مع السعر والمسافة إلى صالة المطار وشحن EV وكاميرات CCTV وتقييمات حقيقية من المسافرين — جنبًا إلى جنب، ومن دون أي إضافات خفية.",
    "how.step1.point1": "مضيفون موثّقون ومتحقَّق من هويتهم فقط",
    "how.step1.point2": "أسعار يومية شفافة",
    "how.step1.point3": "تصفية حسب شحن EV وكاميرات CCTV والمسافة",

    "how.step2.title": "كوّن باقتك",
    "how.step2.body":
      "أضف إلى موقفك توصيلًا مرخّصًا إلى صالة المطار وشحن EV وحماية مباشرة — ثم ادفع مرة واحدة. يقترح ذكاء اصطناعي قابل للتفسير التوليفة المناسبة لرحلتك، بسعر واحد شفاف.",
    "how.step2.point1": "موقف + توصيل + EV + حماية",
    "how.step2.point2": "عملية دفع واحدة وسعر واحد",
    "how.step2.point3": "اقتراحات ذكاء اصطناعي يمكنك فهمها",

    "how.step3.title": "ادفع واحصل على رمز QR",
    "how.step3.body":
      "أتمم الدفع بأمان واحصل فورًا على رمز دخول QR. إنه كل ما تحتاج إليه لبوابة الموقف ولسائقك وللتسليم الموثّق — وكله محفوظ في حجزك.",
    "how.step3.point1": "دفع آمن بالبطاقة",
    "how.step3.point2": "رمز دخول QR فوري",
    "how.step3.point3": "حجز محفوظ في التطبيق من دون اتصال",

    "how.step4.title": "يوم السفر",
    "how.step4.body":
      "تابع كل شيء وهو يحدث. تتبّع سائقك المرخّص على خريطة مباشرة، وشاهد سيارتك المركونة عبر كاميرا مباشرة في التطبيق، وأكّد التسليم الموثّق برمز يُستخدم مرة واحدة — بختم زمني وقيد في السجل.",
    "how.step4.point1": "خريطة مباشرة للعميل والمضيف والسائق",
    "how.step4.point2": "كاميرا مباشرة لسيارتك",
    "how.step4.point3": "تسليم موثّق ومسجَّل",

    "how.step5.title": "العودة والتقييم",
    "how.step5.body":
      "اهبط، ودع السائق يقلّك، واستلم سيارتك بتسليم موثّق آخر. ثم قيّم مضيفك وسائقك — فتقييم الثقة المتبادل يحافظ على نزاهة الشبكة كلها وجودتها العالية.",
    "how.step5.point1": "توصيل العودة فور الهبوط",
    "how.step5.point2": "استلام السيارة بتسليم موثّق",
    "how.step5.point3": "تقييمات متبادلة",

    "how.live.eyebrow": "مباشر في يوم السفر",
    "how.live.title": "راحة بال يمكنك مشاهدتها فعلًا",
    "how.live.body":
      "تنبض ميزات ParkGo الفريدة بالحياة يوم سفرك. هذه الميزات الثلاث تحوّل صباحًا مرهقًا إلى شيء تتابعه في الوقت الفعلي.",
    "how.live.feat1.title": "مشاركة الموقع المباشر",
    "how.live.feat1.body": "أنت ومضيفك وسائقك المرخّص تتشاركون خريطة مباشرة واحدة في يوم السفر.",
    "how.live.feat2.title": "كاميرا مباشرة لسيارتك",
    "how.live.feat2.body": "افتح التطبيق لمشاهدة سيارتك المركونة مع شارة LIVE وختم زمني.",
    "how.live.feat3.title": "تسليم موثّق",
    "how.live.feat3.body": "يؤكّد الطرفان رمزًا يُستخدم مرة واحدة عند التسليم والاستلام — وكل حدث يُقيَّد في السجل.",

    "how.bundle.eyebrow": "سعر واحد شفاف",
    "how.bundle.title": "أربع خدمات مجموعة في عملية دفع واحدة",
    "how.bundle.body":
      "لا تنقّل بين المزوّدين ولا مقارنة بين أشياء لا تُقارن. يجمع ParkGo كل شيء في سعر واحد يمكنك فهمه، مع رسوم خدمة صغيرة تُعرض بوضوح.",
    "how.bundle.item1.title": "موقف خاص موثّق",
    "how.bundle.item1.body": "ممرّ منزلي أو فناء لمضيف متحقَّق من هويته قرب صالة مطارك.",
    "how.bundle.item2.title": "توصيل مرخّص إلى صالة المطار",
    "how.bundle.item2.body": "سائق مرخّص ومؤمَّن عليه إلى باب المطار ومنه.",
    "how.bundle.item3.title": "شحن EV",
    "how.bundle.item3.body": "اشحن سيارتك أثناء سفرك حيثما يوفّر المضيف شاحنًا.",
    "how.bundle.item4.title": "حماية مباشرة",
    "how.bundle.item4.body": "كاميرات CCTV وكاميرا مباشرة وتسليمات موثّقة طوال الرحلة.",

    "how.example.label": "مثال على باقة",
    "how.example.parking": "موقف في المطار",
    "how.example.parkingV": "من المضيف الذي تختاره",
    "how.example.transfer": "توصيل مرخّص",
    "how.example.transferV": "ذهابًا وإيابًا",
    "how.example.ev": "شحن EV",
    "how.example.evV": "إضافة اختيارية",
    "how.example.fee": "رسوم الخدمة",
    "how.example.onePrice": "سعر واحد عند الدفع",
    "how.example.note":
      "مثال استرشادي. يعتمد سعرك على المطار والتواريخ والإضافات التي تختارها.",
    "how.example.cta": "كيف تُحسب الأسعار",

    "how.other.eyebrow": "الوجه الآخر للشبكة",
    "how.other.title": "كيف تعمل الاستضافة، ومن يتولّى توصيلك",
    "how.other.body":
      "ينعم المسافرون برحلة سلسة لأن المضيفين موثّقون ولأن التوصيل إلى صالة المطار يتولاه مشغّل مرخّص. وإليك الخلاصة عن كلٍّ منهما.",

    "how.hosts.title": "للمضيفين",
    "how.hosts.step1.title": "وثّق حسابك",
    "how.hosts.step1.body": "أكّد هويتك وعنوانك، ثم أضف موقفك — الأبعاد وشحن EV وكاميرات CCTV والصور.",
    "how.hosts.step2.title": "انطلق",
    "how.hosts.step2.body": "اجتز مراجعة امتثال سريعة، وحدّد أوقات التوفر، وسيبدأ ممرّك المنزلي بجني الدخل.",
    "how.hosts.step3.title": "استلم أرباحك",
    "how.hosts.step3.body": "استلم مدفوعات آمنة بعد كل حجز مكتمل — وتحتفظ أنت بالنصيب الأكبر.",
    "how.hosts.cta": "أدرج موقفك",

    "how.transfer.title": "من يتولّى توصيلك",
    "how.transfer.body1":
      "لا يشغّل ParkGo أسطولًا ولا يتعاقد مع سائقين. توصيلك إلى صالة المطار يقدّمه مشغّل مستقل مرخّص ومؤمَّن عليه، متكامل مع ParkGo عبر واجهة API. ويأتي مرفقًا مسبقًا بحجز موقفك، فتحصل مع ذلك على سعر واحد عند الدفع.",
    "how.transfer.body2":
      "تبقى تجربة العميل كما هي تمامًا — حجز في باقة واحدة، وموقع مباشر للسائق مع وقت الوصول المتوقّع يوم السفر، وتسليم موثّق — وكل ذلك تشغّله واجهة API الخاصة بالمشغّل بدلًا من تطبيق سائقين من تطوير ParkGo.",
    "how.transfer.cta": "كيف نحافظ على الأمان",

    "how.cta.title": "مستعد لتركن بذكاء وتسافر براحة؟",
    "how.cta.body":
      "ابدأ حجزك في دقائق، أو انضم إلى قائمة الانتظار الخاصة بمطارك وسنخبرك لحظة انطلاقنا.",
    "how.cta.start": "ابدأ الحجز",
    "how.cta.travellers": "للمسافرين",
    "how.cta.airports": "مواقف في أنحاء المملكة المتحدة وأيرلندا — مطارات ومدن وفعاليات.",

    // ----------------------------------------------------------------------- FAQ
    "faq.search.placeholder": "ابحث في المساعدة — جرّب «CCTV» أو «شحن EV»",
    "faq.search.clear": "مسح البحث",
    "faq.search.count": "{n} إجابة",
    "faq.search.none": "لا شيء يطابق بحثك",
    "faq.search.noneHint": "جرّب كلمة أخرى، أو افتح المحادثة واسألنا مباشرة.",
    "faq.hero.badge": "الأسئلة الشائعة",
    "faq.hero.title": "كل ما أردت أن تسأله عن ParkGo",
    "faq.hero.subtitle":
      "إجابات للمسافرين والمضيفين. لم تجد ما تحتاج إليه؟ فريقنا على بُعد رسالة واحدة.",

    "faq.cat.travellers": "للمسافرين",
    "faq.cat.hosts": "للمضيفين",
    "faq.cat.payments": "المدفوعات والأسعار",
    "faq.cat.security": "الأمان واللغات",

    "faq.t1.q": "ما الذي يشمله حجز ParkGo تحديدًا؟",
    "faq.t1.a":
      "يجمع حجز ParkGo في باقة واحدة موقفًا خاصًا موثّقًا، وتوصيلًا مرخّصًا إلى صالة المطار (ذهابًا وإيابًا)، وشحن EV اختياريًا، وحماية مباشرة — كاميرات CCTV وكاميرا في التطبيق وتسليمات موثّقة — بسعر واحد وعملية دفع واحدة.",
    "faq.t2.q": "هل سيارتي بأمان أثناء غيابي؟",
    "faq.t2.a":
      "نعم. المضيفون متحقَّق من هوياتهم، ويمكن أن تشمل المواقف كاميرات CCTV، ويمكنك مشاهدة سيارتك المركونة عبر كاميرا مباشرة في التطبيق مع شارة LIVE وختم زمني. ويجري التسليم والاستلام كلاهما بتسليم موثّق ومسجَّل برمز يُستخدم مرة واحدة.",
    "faq.t3.q": "هل يتولّى سائقون تابعون لـ ParkGo رحلات التوصيل؟",
    "faq.t3.a":
      "لا. لا يشغّل ParkGo أسطولًا ولا يتعاقد مع سائقين. توصيلك إلى صالة المطار يقدّمه مشغّل مستقل مرخّص ومؤمَّن عليه، متكامل مع ParkGo عبر واجهة API. وتحصل مع ذلك على التجربة نفسها — حجز في باقة واحدة، وموقع مباشر للسائق مع وقت الوصول المتوقّع، وتسليم موثّق — بتشغيل من واجهة API الخاصة بالمشغّل.",
    "faq.t4.q": "ماذا يحدث إذا تأخّرت رحلتي الجوية؟",
    "faq.t4.a":
      "موقفك وتوصيل عودتك مرتبطان برحلتك، لذا يُتعامل مع التأخير بسلاسة — فلن تفقد موقفك ولا وسيلة عودتك إلى المنزل. وإذا تغيّرت خططك تغيّرًا كبيرًا، يمكنك إدارة حجزك من التطبيق.",
    "faq.t5.q": "ما المواقع التي يغطّيها ParkGo؟",
    "faq.t5.a":
      "نغطّي مطارات هيثرو وغاتويك وستانستد ولوتون ومانشستر وبرمنغهام وإدنبرة ودبلن، إضافة إلى مواقف في مراكز المدن والمحطات والملاعب في أنحاء المملكة المتحدة وأيرلندا — ومواقع أخرى قادمة. انضم إلى قائمة الانتظار لنخبرك حين نصل إلى موقعك.",

    "faq.h1.q": "من يمكنه أن يصبح مضيفًا؟",
    "faq.h1.a":
      "أي شخص يملك حقًا قانونيًا في تأجير مساحة مناسبة قرب أحد مطارات الإطلاق — ممرّ منزلي أو فناء أو موقف فائض. وتستكمل التحقق من الهوية والعنوان وإقرار حق الإدراج قبل أن يصبح موقفك متاحًا.",
    "faq.h2.q": "كم يمكنني أن أكسب بصفتي مضيفًا؟",
    "faq.h2.a":
      "تحتفظ بالنصيب الأكبر من كل حجز موقف — استرشاديًا نحو 80 إلى 85 بالمئة، تُضاف إليها إيرادات شحن EV حيثما توفّره. وأنت من يحدّد سعرك اليومي وأوقات التوفر. الأرقام استرشادية وستُؤكَّد عند الإطلاق.",
    "faq.h3.q": "كيف ومتى أستلم أرباحي؟",
    "faq.h3.a":
      "تُصرف المدفوعات بعد كل حجز مكتمل وتُرسل إلى البيانات البنكية التي تضيفها أثناء التسجيل. بياناتك البنكية مشفّرة ولا تظهر للمسافرين أبدًا، وتحصل على كشوف واضحة لكل حجز.",

    "faq.p1.q": "كيف تعمل أسعار ParkGo؟",
    "faq.p1.a":
      "يُجمع الموقف والتوصيل المرخّص وشحن EV في سعر واحد شفاف، تُضاف إليه رسوم خدمة ثابتة صغيرة قدرها £2.99 تُعرض دائمًا قبل الدفع. لا إضافات خفية.",
    "faq.p2.q": "كم تبلغ عمولة ParkGo؟",
    "faq.p2.a":
      "استرشاديًا نحو 18 بالمئة على الموقف، إضافة إلى رسوم الخدمة الثابتة، وتظهر بوضوح في كشوف مدفوعات المضيفين. أما التوصيل إلى صالة المطار فيقدّمه مشغّل مستقل مرخّص وهو مشمول في سعر باقتك. الأرقام استرشادية وقابلة للتأكيد.",
    "faq.p3.q": "هل تقدّمون حسابات للشركات؟",
    "faq.p3.a":
      "نعم. تضيف حسابات الشركات حجوزات مركزية، وفوترة شهرية بدلًا من بطاقات لكل رحلة، ودعمًا ذا أولوية، وكشوفًا واضحة لأغراض النفقات. تواصل معنا لإعداد حساب فريقك.",

    "faq.s1.q": "كيف يحمي ParkGo بياناتي؟",
    "faq.s1.a":
      "نوائم ممارساتنا مع اللائحة العامة لحماية البيانات في المملكة المتحدة (UK GDPR) وإرشادات مكتب مفوّض المعلومات (ICO): تقليل البيانات إلى الحد الأدنى، وأساس قانوني لكل استخدام، ومدد احتفاظ محدّدة، وطلبات ميسّرة لأصحاب البيانات. وتُشفَّر وثائق الهوية والوثائق البنكية وتُخزَّن بمعزل، مع سجلات تدقيق وضوابط وصول بمبدأ الحد الأدنى من الصلاحيات.",
    "faq.s2.q": "ماذا يعني التسليم الموثّق؟",
    "faq.s2.a":
      "عند التسليم والاستلام، يؤكّد الطرفان رمزًا يُستخدم مرة واحدة في التطبيق. ويُختم كل تأكيد بطابع زمني ويُقيَّد في سجل تدقيق، ما يؤسس سلسلة عهدة واضحة لسيارتك.",
    "faq.s3.q": "ما اللغات المتاح بها ParkGo؟",
    "faq.s3.a":
      "ينطلق ParkGo بخمس لغات في أنحاء المملكة المتحدة وأيرلندا، مع التخطيط لمزيد منها. ويمكنك تغيير اللغة في أي وقت من ترويسة الموقع.",

    "faq.cta.title": "ما زال لديك سؤال؟",
    "faq.cta.body":
      "يسعدنا مساعدتك في أي شيء يخص الحجوزات أو الاستضافة أو الشراكة أو بياناتك. أرسل لنا رسالة وسنعاود التواصل معك.",
    "faq.cta.contact": "تواصل معنا",
    "faq.cta.how": "كيف تعمل الخدمة",
  },
};
